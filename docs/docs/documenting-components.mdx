...
To show usage examples for the component, create a `.mdx` file next to the component with the same name.
...
- You must call the `render` function in your code block.
