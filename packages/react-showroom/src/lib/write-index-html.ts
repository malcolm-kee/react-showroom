...
<meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover" />${
    ...
    options.resetCss
      ...
      : ''
  }<style>html,body,#target {height: 100%;}</style><!--SSR-style--></head>
<body><div id="target"><!--SSR-target--></div><script type="module" src="/client/client-entry.tsx"></script></body></html>`;

  fs.writeFileSync(resolveShowroom('index.html'), content);
};
